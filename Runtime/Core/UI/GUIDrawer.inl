...
#include "GUIDrawer.h"
template<typename T>
inline ImGuiDataType_ NLS::UI::GUIDrawer::GetDataType()
{
...
template<typename T>
inline std::string NLS::UI::GUIDrawer::GetFormat()
{
...
template<typename T>
inline void NLS::UI::GUIDrawer::DrawScalar(Internal::WidgetContainer& p_root, const std::string& p_name, T& p_data, float p_step, T p_min, T p_max)
{
...
template<typename T>
inline void NLS::UI::GUIDrawer::DrawScalar(Internal::WidgetContainer& p_root, const std::string& p_name, std::function<T(void)> p_gatherer, std::function<void(T)> p_provider, float p_step, T p_min, T p_max)
{
    static_assert(std::is_scalar<T>::value, "T must be a scalar");
