...
namespace NLS::Render::Settings
{
	...
	*/
	...
	{
		BLEND,						// Blend the computed fragment color values with the values already stored in the color buffers.
		...
		SAMPLE_COVERAGE,			// The fragment coverage is combined with the temporary coverage value and can optionally be inverted.
