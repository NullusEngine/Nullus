...
void NLS::Dialogs::FileDialog::SetInitialDirectory(const std::string & p_initialDirectory)
{
...
std::string NLS::Dialogs::FileDialog::GetSelectedFileName()
{
	return m_filename;
}

std::string NLS::Dialogs::FileDialog::GetSelectedFilePath()
{
	return m_filepath;
}

std::string NLS::Dialogs::FileDialog::GetErrorInfo()
{
	return m_error;
}

bool NLS::Dialogs::FileDialog::IsFileExisting() const
{
