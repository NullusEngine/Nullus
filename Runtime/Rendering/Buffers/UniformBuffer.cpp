...
void NLS::Rendering::Buffers::UniformBuffer::_SetSubData(const void* p_data, uint32_t size, size_t p_offset)
{
    glBindBuffer(GL_UNIFORM_BUFFER, m_bufferID);
...
void NLS::Rendering::Buffers::UniformBuffer::_SetSubData(const void* p_data, uint32_t size, std::reference_wrapper<size_t> p_offsetInOut)
{
    glBindBuffer(GL_UNIFORM_BUFFER, m_bufferID);
