...
**Independent Test**: Asset database tests import `.hlsl` files and verify `.shader` artifacts, `manifest.json`, `ArtifactDB/index.tsv`, startup preimport planning, and artifact-loader resolution without requiring runtime source compilation.
