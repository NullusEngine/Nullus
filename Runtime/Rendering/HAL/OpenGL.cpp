...
constexpr GLenum ToGLEnum(Rendering::Settings::ERasterizationMode value)
{
	return GL_POINT + static_cast<GLint>(value);
}

constexpr GLenum ToGLEnum(Rendering::Settings::EComparaisonAlgorithm value)
{
	return GL_NEVER + static_cast<GLint>(value);
}

constexpr GLenum ToGLEnum(Rendering::Settings::ECullFace value)
{
	switch (value)
	{
	case Rendering::Settings::ECullFace::FRONT: return GL_FRONT;
	case Rendering::Settings::ECullFace::BACK: return GL_BACK;
	case Rendering::Settings::ECullFace::FRONT_AND_BACK: return GL_FRONT_AND_BACK;
	}
...
constexpr GLenum ToGLEnum(Rendering::Settings::EOperation value)
{
	switch (value)
	{
	case Rendering::Settings::EOperation::KEEP: return GL_KEEP;
	case Rendering::Settings::EOperation::ZERO: return GL_ZERO;
	case Rendering::Settings::EOperation::REPLACE: return GL_REPLACE;
	case Rendering::Settings::EOperation::INCREMENT: return GL_INCR;
	case Rendering::Settings::EOperation::INCREMENT_WRAP: return GL_INCR_WRAP;
	case Rendering::Settings::EOperation::DECREMENT: return GL_DECR;
	case Rendering::Settings::EOperation::DECREMENT_WRAP: return GL_DECR_WRAP;
	case Rendering::Settings::EOperation::INVERT: return GL_INVERT;
	}
...
constexpr GLenum ToGLEnum(Rendering::Settings::ERenderingCapability value)
{
	switch (value)
	{
	case Rendering::Settings::ERenderingCapability::BLEND: return GL_BLEND;
	case Rendering::Settings::ERenderingCapability::CULL_FACE: return GL_CULL_FACE;
	case Rendering::Settings::ERenderingCapability::DEPTH_TEST: return GL_DEPTH_TEST;
	case Rendering::Settings::ERenderingCapability::DITHER: return GL_DITHER;
	case Rendering::Settings::ERenderingCapability::POLYGON_OFFSET_FILL: return GL_POLYGON_OFFSET_FILL;
	case Rendering::Settings::ERenderingCapability::SAMPLE_ALPHA_TO_COVERAGE: return GL_SAMPLE_ALPHA_TO_COVERAGE;
	case Rendering::Settings::ERenderingCapability::SAMPLE_COVERAGE: return GL_SAMPLE_COVERAGE;
	case Rendering::Settings::ERenderingCapability::SCISSOR_TEST: return GL_SCISSOR_TEST;
	case Rendering::Settings::ERenderingCapability::STENCIL_TEST: return GL_STENCIL_TEST;
	case Rendering::Settings::ERenderingCapability::MULTISAMPLE: return GL_MULTISAMPLE;
	}
...
constexpr GLenum ToGLEnum(Rendering::Settings::EPrimitiveMode value)
{
	switch (value)
	{
	case Rendering::Settings::EPrimitiveMode::POINTS: return GL_POINTS;
	case Rendering::Settings::EPrimitiveMode::LINES: return GL_LINES;
	case Rendering::Settings::EPrimitiveMode::LINE_LOOP: return GL_LINE_LOOP;
	case Rendering::Settings::EPrimitiveMode::LINE_STRIP: return GL_LINE_STRIP;
	case Rendering::Settings::EPrimitiveMode::TRIANGLES: return GL_TRIANGLES;
	case Rendering::Settings::EPrimitiveMode::TRIANGLE_STRIP: return GL_TRIANGLE_STRIP;
	case Rendering::Settings::EPrimitiveMode::TRIANGLE_FAN: return GL_TRIANGLE_FAN;
	case Rendering::Settings::EPrimitiveMode::LINES_ADJACENCY: return GL_LINES_ADJACENCY;
	case Rendering::Settings::EPrimitiveMode::LINE_STRIP_ADJACENCY: return GL_LINE_STRIP_ADJACENCY;
	case Rendering::Settings::EPrimitiveMode::PATCHES: return GL_PATCHES;
	}
...
*/
Rendering::Data::PipelineState RetrieveOpenGLPipelineState()
{
