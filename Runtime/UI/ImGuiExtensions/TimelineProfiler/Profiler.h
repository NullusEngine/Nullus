...
namespace TimelineProfilerDetail
{
constexpr bool ShouldUnregisterCommandListDestructionCallback(bool isDestroyingFromCallback, uint32 destructionEventID)
{
	return !isDestroyingFromCallback && destructionEventID != 0;
}

constexpr bool ShouldPublishGpuQueryPair(bool isValidQueryPair)
{
...
private:
	...
	struct CommandListState
	{
		...
		bool					IsDestroyingFromCallback = false;
