...
template<>                                          \
struct NLS::SI_InterfaceTraits<Interface> {        \
	using IList = TemplateList<__VA_ARGS__>;        \
}

#define SI_InterfaceTraits_Register_Pro(Interface, ...)                            \
template<>                                                                         \
struct NLS::SI_InterfaceTraits<Interface> : NLS::details::IListBase<__VA_ARGS__>
...
template<>                                   \
struct NLS::SI_ImplTraits<Impl> {           \
	using IList = TemplateList<__VA_ARGS__>; \
}

#define SI_ImplTraits_Register_Pro(Impl, ...)                             \
template<>                                                                \
struct NLS::SI_ImplTraits<Impl> : NLS::details::IListBase<__VA_ARGS__>
