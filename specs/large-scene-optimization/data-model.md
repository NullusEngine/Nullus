...
- `fadeDurations`: Optional transition durations.
...
- Selection chooses one active LOD outside fade windows.
- Fade windows may include two LODs only when explicitly enabled.
