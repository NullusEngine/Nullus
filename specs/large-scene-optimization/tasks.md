...
**Independent Test**: LOD thresholds, HLOD proxy selection, child suppression, hysteresis, reserved fade metadata, proxy readiness fallback, and editor selection override are deterministic; rendered cross-fade is explicitly out of this slice.
