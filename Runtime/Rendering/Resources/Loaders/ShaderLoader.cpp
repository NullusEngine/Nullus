...
std::string NLS::Render::Resources::Loaders::ShaderLoader::__FILE_TRACE;

NLS::Render::Resources::Shader* NLS::Render::Resources::Loaders::ShaderLoader::Create(const std::string& p_filePath)
{
...
NLS::Render::Resources::Shader* NLS::Render::Resources::Loaders::ShaderLoader::CreateFromSource(const std::string& p_vertexShader, const std::string& p_fragmentShader)
{
...
void NLS::Render::Resources::Loaders::ShaderLoader::Recompile(Shader& p_shader, const std::string& p_filePath)
{
	__FILE_TRACE = p_filePath;
...
bool NLS::Render::Resources::Loaders::ShaderLoader::Destroy(Shader*& p_shader)
{
	if (p_shader)
	{
		delete p_shader;
...
std::pair<std::string, std::string> NLS::Render::Resources::Loaders::ShaderLoader::ParseShader(const std::string& p_filePath)
{
...
uint32_t NLS::Render::Resources::Loaders::ShaderLoader::CreateProgram(const std::string& p_vertexShader, const std::string& p_fragmentShader)
{
...
uint32_t NLS::Render::Resources::Loaders::ShaderLoader::CompileShader(uint32_t p_type, const std::string& p_source)
{
