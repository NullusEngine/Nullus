...
# Keep CMake's dependency graph and the MSBuild project pointed at the same
# source tree.  A clean repository build uses the sample project assets;
# editor builds override this with NLS_PROJECT_ASSETS_DIR.
set(NLS_MANAGED_PROJECT_ASSETS_DIR "${NLS_PROJECT_ASSETS_DIR}")
if(NOT NLS_MANAGED_PROJECT_ASSETS_DIR)
    set(NLS_MANAGED_PROJECT_ASSETS_DIR "${CMAKE_SOURCE_DIR}/TestProject/Assets")
endif()
set(NLS_MANAGED_PROJECT_ASSETS_ARG
    "-p:NullusProjectAssets=${NLS_MANAGED_PROJECT_ASSETS_DIR}")
...
file(GLOB_RECURSE NLS_PROJECT_SCRIPT_SOURCE_FILES CONFIGURE_DEPENDS
    "${NLS_MANAGED_PROJECT_ASSETS_DIR}/*.cs")
