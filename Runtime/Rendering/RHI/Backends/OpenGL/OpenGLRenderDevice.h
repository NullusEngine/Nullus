...
{
	class NLS_RENDER_API OpenGLRenderDevice final : public NLS::Render::RHI::IRenderDevice
	{
	public:
		...
		void SetStencilOperations(
			...
			NLS::Render::Settings::EOperation bothPass) override;
