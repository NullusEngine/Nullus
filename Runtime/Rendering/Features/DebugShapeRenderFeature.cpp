...
void Rendering::Features::DebugShapeRenderFeature::SetViewProjection(const Maths::Matrix4& p_viewProjection)
{
	m_lineShader->Bind();
...
void Rendering::Features::DebugShapeRenderFeature::DrawSphere(Rendering::Data::PipelineState p_pso, const Maths::Vector3& p_position, const Maths::Quaternion& p_rotation, float p_radius, const Maths::Vector3& p_color, float p_lineWidth)
{
...
void Rendering::Features::DebugShapeRenderFeature::DrawCapsule(Rendering::Data::PipelineState p_pso, const Maths::Vector3& p_position, const Maths::Quaternion& p_rotation, float p_radius, float p_height, const Maths::Vector3& p_color, float p_lineWidth)
{
	if (!std::isinf(p_radius))
	{
