...
## Nullus vendoring note

This copy was imported from https://github.com/CedricGuillemet/ImGuizmo at
master commit `6e44c83a5c449d56449f5d27a876e4904c1b9c5b` on 2026-05-04.
Nullus builds only `ImGuizmo.h` and `ImGuizmo.cpp`; the upstream MIT license is
kept in `LICENSE`.
