...
void Editor::Panels::MenuBar::CreateHelpMenu()
{
    ...
    helpMenu.CreateWidget<MenuItem>("GitHub").ClickedEvent += [] {Platform::SystemCalls::OpenURL("https://github.com/NullusEngine/Nullus"); };
    helpMenu.CreateWidget<Visual::Separator>();
    helpMenu.CreateWidget<MenuItem>("Bug Report").ClickedEvent += [] {Platform::SystemCalls::OpenURL("https://github.com/NullusEngine/Nullus/issues/new?assignees=&labels=Bug&template=bug_report.md&title="); };
    helpMenu.CreateWidget<MenuItem>("Feature Request").ClickedEvent += [] {Platform::SystemCalls::OpenURL("https://github.com/NullusEngine/Nullus/issues/new?assignees=&labels=Feature&template=feature_request.md&title="); };
    helpMenu.CreateWidget<Visual::Separator>();
