...
namespace NLS::UDRefl {
	...
	NLS_BASE_API std::pmr::memory_resource* ReflMngr_GetTemporaryResource();

	class NLS_BASE_API ObjectView {
	public:
	...
	class NLS_BASE_API SharedObject : public ObjectView {
	public:
