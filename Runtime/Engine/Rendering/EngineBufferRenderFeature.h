...
private:
    void EnsureExplicitBindingLayouts();
...
protected:
    ...
    std::shared_ptr<NLS::Render::RHI::RHIBindingLayout> m_explicitFrameBindingLayout;
    std::shared_ptr<NLS::Render::RHI::RHIBindingLayout> m_explicitObjectBindingLayout;
    ...
    NLS::Render::RHI::NativeBackendType m_explicitBindingsBackend = NLS::Render::RHI::NativeBackendType::None;
